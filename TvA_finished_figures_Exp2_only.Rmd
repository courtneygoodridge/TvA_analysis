...
This script produces the maunscript figures from the paper and saves them into the *Manuscript plots* folder. Data for plotting is taken from the Data folder and the relevant sub folders within them. 
...
```{r}magnitudedata <- read.csv(here::here("TvA_analysis/Data/Processed/magnitudedata.csv"))
...
Threshold versus Accumulator example. 
...
Experimental design. Details orientation angles and starting position locations from bird's eye view. 
...
Schematic representation of Threshold and Accumulator differences when including an initial error manipulation within the design. 

## Figure 5

```{r}
accum_response_latency <- read.csv(here::here("TvA_analysis/Data/Sim_Data/accum_rt_latency_exp2.csv"), header = FALSE)
threshold_response_latency <- read.csv(here::here("TvA_analysis/Data/Sim_Data/threshold_rt_latency_exp2.csv"), header = FALSE)
...
Accumulator vs Threshold predictions + RT data.

## Figure 6

```{r}
accum_error_latency <- read.csv(here::here("TvA_analysis/Data/Sim_Data/accum_lpe_latency_exp2.csv"), header = FALSE)
threshold_error_latency <- read.csv(here::here("TvA_analysis/Data/Sim_Data/threshold_lpe_latency_exp2.csv"), header = FALSE)
...
Accumulator vs Threshold predictions + lateral position error data.
...
comparison of steering wheel angle over time and steering rate over time. 
...
birdseye trajectory p[lot and average position relative to road-line at respone. 
