...
ggplot() +
  ...
  geom_label(aes(x = 0.3, y = 3.4, label = "Fixed threshold"), fontface = "bold", hjust = 0, vjust = 0.5, colour = "black", fill = "white", label.size = NA, family = "Arial", size = 2.6) +
  ...
  theme_plot +
  theme(legend.position = c(0.33, 0.83), legend.spacing.y = unit(0.1, "cm"), legend.margin = margin(0.05,0.05,0,0, unit = "cm"), legend.key = element_blank(), legend.key.width = unit(0.5, 'cm'), legend.key.size = unit(0, 'cm'), axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.title.y = element_text(size = 9), plot.title = element_text(size = 20, face = "bold"), axis.title.x = element_text(size = 9), axis.ticks.x = element_blank(), axis.text.x = element_blank(), title = element_text(size = 9), legend.title = element_text(size = 11, face = "bold"), legend.text = element_text(size = 9), axis.line.y = element_line(arrow = grid::arrow(length = unit(0.5, "cm"), ends = "last")), axis.line.x = element_line(arrow = grid::arrow(length = unit(0.5, "cm"), ends = "last"))) +
  ggsave('Fig1.tiff', plot = last_plot(), width = 7, height = 7, units = 'cm', dpi = 300, type = 'cairo')
```
...
ggplot() +
  ...
  annotate("text", x = 0.1, y = 0, size = 3, label = "T0") +
  geom_point(experiment_2_coordinates %>%
               dplyr::filter(heading == 1, startingpos == 0) %>%
  ...
  annotate("text", x = 0.19, y = 7.23, size = 3, label = "T1") +
  geom_point(experiment_2_coordinates %>%
  ...
  geom_curve(experiment_2_coordinates %>%
   ...
   annotate("text", x = 0.22, y = 4, size = 3, label = "T0") +
  geom_point(experiment_2_coordinates %>%
               dplyr::filter(heading == 2, startingpos == 4) %>%
  ...
  annotate("text", x = 0.43, y = 9.86, size = 3, label = "T1") +
  geom_point(experiment_2_coordinates %>%
  ...
  annotate("text", x = -0.38, y = 8, size = 3, label = "T0") +
  geom_point(experiment_2_coordinates %>%
               dplyr::filter(heading == 2, startingpos == 8) %>%
  ...
  annotate("text", x = -0.58, y = 13.85, size = 3, label = "T1") +
  scale_fill_manual(name = " Starting position (m)", values = c("black", "darkgrey", "white"), labels = c("0", "4", "8")) +
  geom_vline(mapping = aes(xintercept = 0), size = 1, alpha = 0.7) +
  annotate("text", x = -0.66, y = 20.5, size = 3, label = "-2.0°") +
  annotate("text", x = -0.33, y = 20.5, size = 3, label = "-1.0°") +
  ...
  annotate("text", x = -0.18, y = 16.5, size = 3, label = "LPE") +
  ylab("z (m)") +
  xlab("x (m)") +
  ylim(0, 21) +
  xlim(-0.7, 0.7) +
  theme_plot +
  theme(legend.position = c(0.20, 0.14), legend.key.height = unit(0, 'cm'), legend.key.width = unit(0.5, 'cm'), legend.key = element_blank(), legend.spacing.y = unit(0.1, "cm"), legend.margin = margin(0.05,0.05,0,0, unit = "cm"), legend.key.size = unit(0, 'cm'), plot.title = element_text(size = 19, face = "bold"), axis.title.x = element_text(size = 9), axis.text.x = element_text(size = 9), axis.title.y = element_text(size = 9), axis.text.y = element_text(size = 9), title = element_text(size = 7), legend.title = element_text(size = 6.5), legend.text = element_text(size = 8)) +
  ggsave('Fig3.tiff', plot = last_plot(), width = 7, height = 7, units = 'cm', dpi = 300, type = 'cairo')
```
...
ggplot() +
  ...
  theme_plot +
  theme(legend.position = c(0.33, 0.83), legend.spacing.y = unit(0.1, "cm"), legend.margin = margin(0.05,0.05,0,0, unit = "cm"), legend.key = element_blank(), legend.key.width = unit(0.5, 'cm'), legend.key.size = unit(0, 'cm'), axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.title.y = element_text(size = 9), plot.title = element_text(size = 20, face = "bold"), axis.title.x = element_text(size = 9), axis.ticks.x = element_blank(), axis.text.x = element_blank(), title = element_text(size = 9), legend.title = element_text(size = 11, face = "bold"), legend.text = element_text(size = 9), axis.line.y = element_line(arrow = grid::arrow(length = unit(0.5, "cm"), ends = "last")), axis.line.x = element_line(arrow = grid::arrow(length = unit(0.5, "cm"), ends = "last"))) +
  ggsave('Fig4.tiff', plot = last_plot(), width = 7, height = 7, units = 'cm', dpi = 300, type = 'cairo')
```
...
threshold_response_latency <- threshold_response_latency %>%
  dplyr::mutate(rt = rt / 3)

sim_preds_response <- rbind(accum_response_latency, threshold_response_latency) 


"RT predictionsfor experiment 2"
setwd("C:/Users/pscmgo/OneDrive for Business/PhD/Project/Experiment_Code/experiment_1/Publication_figures/Finished_Figs_Exp2_only")
ggplot(sim_preds_response %>%
         dplyr::filter(perceptual_var == "visual_angle"), mapping = aes(x = heading, y = rt, linetype = as.factor(startingpos), col = model)) +
  geom_line() +
  scale_linetype_manual(name = "Starting position (m)", labels = c("0", "4", "8"),  values = c("dotted", "dashed", "solid")) +
  scale_colour_manual(name = "Framework", labels = c("Accumulator", "Threshold"), values = c("red", "blue")) +
  scale_x_continuous(name = "Orientation (°)", breaks = c(1, 2)) +
  ylab("Reaction time (s)") +
  ylim(0, 1.3) +
  theme_plot +
  theme(legend.position = c(0.66, 0.78), legend.key.height = unit(0, 'cm'), legend.margin = margin(0,0,0,0, unit = "cm"), legend.key.width = unit(0.5, 'cm'), legend.key = element_blank(), legend.key.size = unit(0, 'cm'), strip.text.x = element_blank(), plot.title = element_text(size = 20, face = "bold"), panel.spacing = unit(2, "lines"), axis.title.x = element_text(size = 9), axis.text.x = element_text(size = 9), axis.title.y = element_text(size = 9), axis.text.y = element_text(size = 9), title = element_text(size = 7), legend.title = element_text(size = 9), legend.text = element_text(size = 9)) +
  facet_grid(~ model) +
  ggsave('Fig5.tiff', plot = last_plot(), width = 7, height = 7, units = 'cm', dpi = 300,  type = 'cairo')
```
...
"scaling factor"
threshold_error_latency <- threshold_error_latency %>%
  dplyr::mutate(LPE = case_when(startingpos == 8 ~ LPE,
                                    startingpos == 4 ~ LPE + 0.016,
                                    startingpos == 0 ~ LPE + 0.016)) 

sim_preds_error <- rbind(accum_error_latency, threshold_error_latency)

"LPE predictions"
setwd("C:/Users/pscmgo/OneDrive for Business/PhD/Project/Experiment_Code/experiment_1/Publication_figures/Finished_Figs_Exp2_only")
ggplot(sim_preds_error %>%
         dplyr::filter(perceptual_var == "visual_angle"), mapping = aes(x = heading, y = LPE, linetype = as.factor(startingpos), col = model)) +
  geom_line() +
  scale_linetype_manual(name = "Starting position (m)", labels = c("0", "4", "8"),  values = c("dotted", "dashed", "solid")) +
  scale_colour_manual(name = "Framework", labels = c("Accumulator", "Threshold"), values = c("red", "blue")) +
  scale_x_continuous(name = "Orientation (°)", breaks = c(1, 2)) +
  ...
  ylim(0, 0.3) +
  theme_plot +
  theme(legend.position = c(0.75, 0.75), legend.key.height = unit(0, 'cm'), legend.key.width = unit(0.5, 'cm'), legend.key = element_blank(), legend.key.size = unit(0, 'cm'), strip.text.x = element_blank(), plot.title = element_text(size = 20, face = "bold"), panel.spacing = unit(2, "lines"), axis.title.x = element_text(size = 9), axis.text.x = element_text(size = 9), axis.title.y = element_text(size = 9), axis.text.y = element_text(size = 9), title = element_text(size = 7), legend.title = element_text(size = 9), legend.text = element_text(size = 9)) +
  facet_grid(~ model) +
  ggsave('Fig6.tiff', plot = last_plot(), width = 7, height = 7, units = 'cm', dpi = 300,  type = 'cairo')
```
...
swa.plot <- ggplot() +
  ...
  xlab("Time (s)") +
  theme_plot +
  theme(legend.position = c(0.85, 0.90), legend.key.height = unit(0, 'cm'), legend.key.width = unit(0.5, 'cm'), legend.key.size = unit(0, 'cm'), strip.text.x = element_blank(), plot.title = element_text(size = 20, face = "bold"), panel.spacing = unit(2, "lines"), axis.title.x = element_text(size = 9), axis.text.x = element_text(size = 9), axis.title.y = element_text(size = 9), axis.text.y = element_text(size = 9), title = element_text(size = 7), legend.title = element_text(size = 7), legend.text = element_text(size = 7)) 
...
ggsave('Fig7.tiff', g,  width = 15, height = 7, units = 'cm', dpi = 300, type = 'cairo')
```
...
ggplot() +
  ...
  scale_colour_manual(name = "Orientation (°)", labels = c("1", "2"), values = c(my_cols)) +
  ...
  theme_plot +
  theme(legend.position = c(0.25, 0.24), legend.key.height = unit(0, 'cm'), legend.key = element_blank(), legend.spacing.y = unit(0.1, "cm"), legend.margin = margin(0.1,0.1,0,0, unit = "cm"), legend.key.width = unit(0.5, 'cm'), legend.key.size = unit(0, 'cm'), strip.text.x = element_blank(), plot.title = element_text(size = 20, face = "bold"), panel.spacing = unit(2, "lines"), axis.title.x = element_text(size = 9), axis.text.x = element_text(size = 9), axis.title.y = element_text(size = 9), axis.text.y = element_text(size = 9), title = element_text(size = 7), legend.title = element_text(size = 8), legend.text = element_text(size = 8)) +
  ggsave('Fig8.tiff', plot = last_plot(), width = 7, height = 7, units = 'cm', dpi = 300, type = 'cairo')
```
...
ggplot(sim_preds_response %>%
  ...
  ylim(0, 1.2) +
  theme_plot +
  theme(legend.position = c(0.85, 0.75), legend.key.height = unit(0, 'cm'), legend.key = element_blank(), legend.key.width = unit(0.5, 'cm'), legend.key.size = unit(0, 'cm'), strip.text.x = element_blank(), plot.title = element_text(size = 20, face = "bold"), panel.spacing = unit(2, "lines"), axis.title.x = element_text(size = 9), axis.text.x = element_text(size = 9), axis.title.y = element_text(size = 9), axis.text.y = element_text(size = 9), title = element_text(size = 7), legend.title = element_text(size = 7.5), legend.text = element_text(size = 7.5)) +
  facet_grid(~ model) +
  ggsave('Fig9.1.tiff', plot = last_plot(), width = 10, height = 7, units = 'cm', dpi = 900, type = 'cairo')
...
ggplot() +
  ...
  ylab("Reaction time (s)") +
  theme_plot +
  theme(legend.position = c(0.70, 0.90), legend.key.height = unit(0, 'cm'), legend.key = element_blank(), legend.key.width = unit(0.5, 'cm'), legend.key.size = unit(0, 'cm'), strip.text.x = element_blank(), plot.title = element_text(size = 20, face = "bold"), panel.spacing = unit(2, "lines"), axis.title.x = element_text(size = 9), axis.text.x = element_text(size = 9), axis.title.y = element_text(size = 9), axis.text.y = element_text(size = 9), title = element_text(size = 7), legend.title = element_text(size = 7), legend.text = element_text(size = 7)) +
  ggsave('Fig9.2.tiff', plot = last_plot(), width = 5, height = 7, units = 'cm', dpi = 900, type = 'cairo')
```
...
ggplot(sim_preds_error %>%
  ...
  theme(legend.position = c(0.85, 0.75), legend.key.height = unit(0, 'cm'), legend.key = element_blank(), legend.key.width = unit(0.5, 'cm'), legend.key.size = unit(0, 'cm'), strip.text.x = element_blank(), plot.title = element_text(size = 20, face = "bold"), panel.spacing = unit(2, "lines"), axis.title.x = element_text(size = 9), axis.text.x = element_text(size = 9), axis.title.y = element_text(size = 9), axis.text.y = element_text(size = 9), title = element_text(size = 7), legend.title = element_text(size = 8), legend.text = element_text(size = 8)) +
  facet_grid(~ model) +
  ggsave('Fig10.1.tiff', plot = last_plot(), width = 10, height = 7, units = 'cm', dpi = 900, type = 'cairo')
...
ggplot() +
  ...
  ylim(0, 0.6) +
  theme_plot +
  theme(legend.position = c(0.50, 0.80), legend.key.height = unit(0, 'cm'), legend.key = element_blank(), legend.key.width = unit(0.5, 'cm'), legend.key.size = unit(0, 'cm'), strip.text.x = element_blank(), plot.title = element_text(size = 20, face = "bold"), panel.spacing = unit(2, "lines"), axis.title.x = element_text(size = 9), axis.text.x = element_text(size = 9), axis.title.y = element_text(size = 9), axis.text.y = element_text(size = 9), title = element_text(size = 7), legend.title = element_text(size = 8), legend.text = element_text(size = 8)) +
  ggsave('Fig10.2.tiff', plot = last_plot(), width = 5, height = 7, units = 'cm', dpi = 900, type = 'cairo')
```
...
ggplot() +
  ...
  ylab("Steering wheel angle (°)") +
  theme_plot +
  theme(legend.position = c(0.32, 0.90), legend.key.height = unit(0, 'cm'), legend.key = element_blank(), legend.key.width = unit(0.5, 'cm'), legend.key.size = unit(0, 'cm'), strip.text.x = element_blank(), plot.title = element_text(size = 20, face = "bold"), panel.spacing = unit(2, "lines"), axis.title.x = element_text(size = 9), axis.text.x = element_text(size = 9), axis.title.y = element_text(size = 9), axis.text.y = element_text(size = 9), title = element_text(size = 7), legend.title = element_text(size = 9), legend.text = element_text(size = 9)) +
  ggsave('Fig11.tiff', plot = last_plot(), width = 7, height = 7, units = 'cm', dpi = 300, type = 'cairo')
```
