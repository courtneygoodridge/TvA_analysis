...
#### Experiment 2 analysis - cleaning data 

The first section of the analysis aims to do the following:

- select the appropriate data we want to analyse
- mirror steering responses 
- process steering metrics at onset and peak
- save these metrics for each valid trials into final dataframe
...
print("female")
length(dplyr::filter(gender, gender == 1)) 

print("male")
length(dplyr::filter(gender, gender == 2))
