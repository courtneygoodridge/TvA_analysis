...
def predict_response(simResults, startingpos = [0, .5, 1], ego = 10, alphadot = 30): # starting positions were startingpos = [0, .5, 1]
...
pred_thres_latency, pred_accum_latency = predict_response(simResults, startingpos = [0, 0.5, 1], ego = 10)

# RT predictions for experiment 2
#Threshold
threshold_rt_latency_exp2 = pred_thres_latency[0][:, 0:3]
threshold_rt_latency_exp2 = np.transpose(threshold_rt_latency_exp2)
rt_thres_vis_angle = threshold_rt_latency_exp2[0] 
...
rt_thres_vis_angle.to_csv("threshold_rt_latency_exp2.csv")

#Accumulator
accum_rt_latency_exp2 = pred_accum_latency[0][:, 0:3]
accum_rt_latency_exp2 = np.transpose(accum_rt_latency_exp2)
rt_accum_vis_angle = accum_rt_latency_exp2[0] 
...
rt_accum_vis_angle.to_csv("accum_rt_latency_exp2.csv")

# LPE predictions for experiment 2
#Threshold
threshold_lpe_latency_exp2 = pred_thres_latency[1][:, 0:3]
threshold_lpe_latency_exp2 = np.transpose(threshold_lpe_latency_exp2)
error_thres_vis_angle = threshold_lpe_latency_exp2[0] 
...
error_thres_vis_angle.to_csv("threshold_lpe_latency_exp2.csv")

#Accumulator
accum_lpe_latency_exp2 = pred_accum_latency[1][:, 0:3]
accum_lpe_latency_exp2 = np.transpose(accum_lpe_latency_exp2)
error_accum_vis_angle = accum_lpe_latency_exp2[0] 
...
error_accum_vis_angle.to_csv("accum_lpe_latency_exp2.csv")
